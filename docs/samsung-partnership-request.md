...
- The Tizen application source, publicly available under the MIT licence
- A signed test build for any panel model Samsung specifies, with its DUID
- Technical contact for the Samsung Engineering team

## Specific asks
1. Partner Seller membership for ByteTinker LLC's seller group
2. Confirmation of the distributor certificate level required for URL Launcher installation on
   retail SSSP panels, and whether that certificate is bound to enrolled device IDs (DUIDs) or
   permits general distribution
